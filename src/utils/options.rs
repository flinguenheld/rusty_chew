...
pub const SCROLL_TEMP_SPEED_1: (u32, i8) = (8, 1);
pub const SCROLL_TEMP_SPEED_2: (u32, i8) = (4, 1);
pub const SCROLL_TEMP_SPEED_3: (u32, i8) = (1, 8);
pub const SCROLL_TEMP_SPEED_4: (u32, i8) = (1, 15);
pub const SCROLL_TEMP_SPEED_DEFAULT: (u32, i8) = (2, 1);
